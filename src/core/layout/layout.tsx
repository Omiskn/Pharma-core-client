...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const connectionState = apiHealth.isLoading
    ? {
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-16 bg-card border-b flex items-center justify-between px-6 shadow-sm z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className={cn("flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium border", connectionState.className)}>
              <div className={cn("w-2 h-2 rounded-full animate-pulse", connectionState.dotClassName)} />
